                ...
                <div className='blog-card'>
                    ...
                    <div className='blog-card-text'>
                        ...
                        <button onClick={() => handleLike("Comprehensive Care Guide for Stray Animals: A Compassionate Approach")}>
                            <FontAwesomeIcon icon={faThumbsUp} /> {likes["Comprehensive Care Guide for Stray Animals: A Compassionate Approach"]}
                        </button>
                    </div>
                </div>
                ...
                <div className='blog-card'>
                    ...
                    <div className='blog-card-text'>
                        ...
                        <button onClick={() => handleLike("Nutrition and diet guide for stray animals!")}>
                            <FontAwesomeIcon icon={faThumbsUp} /> {likes["Nutrition and diet guide for stray animals!"]}
                        </button>
                ...
                <div className='blog-card'>
                    ...
                    <div className='blog-card-text'>
                        ...
                        <button onClick={() => handleLike("Understanding and Training Stray Animal Behavior: Tips for Success")}>
                            <FontAwesomeIcon icon={faThumbsUp} /> {likes["Understanding and Training Stray Animal Behavior: Tips for Success"]}
                        </button>
                    </div>
                </div>
                ...
                <div className='blog-card'>
                    ...
                    <div className='blog-card-text'>
                        ...
                        <button onClick={() => handleLike("Emergency Care and First Aid Tips for Stray Animals")}>
                            <FontAwesomeIcon icon={faThumbsUp} /> {likes["Emergency Care and First Aid Tips for Stray Animals"]}
                        </button>
                    </div>
                </div>
